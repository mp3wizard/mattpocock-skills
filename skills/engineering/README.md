...
- **[resolving-merge-conflicts](./resolving-merge-conflicts/SKILL.md)** — Resolve an in-progress git merge or rebase conflict, hunk by hunk, tracing each side back to its primary source before deciding — never `--abort`.
